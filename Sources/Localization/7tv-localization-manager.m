...
- (void)s7tv_buildTable {
    _table = @{
        ...
        @"switch_hide_chat_vertical_content": @[@"Masquer tout le bandeau du chat", @"Hide entire chat top banner"],
        @"switch_hide_chat_top_callout":      @[@"Masquer Drops/Hype Train/Pronostics/Sondages", @"Hide Drops/Hype Train/Predictions/Polls"],
        @"switch_hide_creator_goals_banner":  @[@"Masquer le bandeau d'objectifs Abos/Followers", @"Hide Sub/Follower goals banner"],
        @"switch_hide_leaderboard_banner":    @[@"Masquer le bandeau de classement", @"Hide leaderboard banner"],
        @"chat_subtoggle_superseded":         @[@"Déjà masqué par « Masquer tout le bandeau du chat », qui couvre cette vue puisqu'elle en fait partie. Désactivez ce réglage pour reprendre le contrôle individuel de cette bannière.",
                                                  @"Already hidden by “Hide entire chat top banner”, which covers this view since it lives inside it. Turn that setting off to control this banner individually."],
